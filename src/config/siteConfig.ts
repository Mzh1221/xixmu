...
export const siteConfig: SiteConfig = {
	...
	// 站点 URL
	site_url: "https://www.xixmu.top",

	// 站点描述
	description:
		"基于 Firefly 博客主题模板搭建的个人博客，记录生活、分享技术、交流学习，欢迎访问我的博客！",
	...
	favicon: [
		{
			// 图标文件路径
			src: "https://s41.ax1x.com/2026/07/11/pmsDpgU.png",
			// 可选，指定主题 'light' | 'dark'
			// theme: "light",
			// 可选，图标大小
			// sizes: "32x32",
	...
	navbar: {
		...
		logo: {
			type: "url",
			value: "https://s41.ax1x.com/2026/07/11/pmsDpgU.png",
			alt: "Logo",
		},
		// type: "image",
